...
export const convention = Object.freeze({
  ...
  issues: [
    { id: 'integration', label: '정치 통합·연대의 절차', scope: '조국혁신당을 포함한 개혁·진보 세력과의 연대·통합 논의', positions: fillUnknown([
      ...
      { candidateId: 'jung-cheong-rae', status: '직접 확인', quote: '폭탄선언하고 망가지는 논의', date: '2026-08-08', sourceId: 'yna-procedure', tier: '보도·발언 인용', boundary: '김민석 후보가 언급한 합당 논의 방식에 대한 비판 인용입니다. 정청래 후보의 대안 절차가 제시된 것으로 표시하지 않습니다.' },
    ]) },

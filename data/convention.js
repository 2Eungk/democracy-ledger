...
export const convention = Object.freeze({
  ...
  showcaseRecords: [
    ...
    {
      id: 'choi-min-hee-deliberation-on-dissent',
      person: { id: 'choi-min-hee', name: '최민희', office: '더불어민주당 최고위원', portrait: { url: 'https://theminjoo.kr/people/connect/people/1288/profile.jpg', sourceUrl: 'https://theminjoo.kr/main/sub/introduce/team.php?class=2', label: '더불어민주당 공개 프로필 사진' } },
      recordClass: '당 공식 회의 발언',
      issueLabel: '전당대회 이후 당내 이견의 토론·숙의 언급',
      status: '직접 확인',
      quote: '저는 민주당 내에 이견이 발생하면 토론하면 되고 숙의를 통해 정답을 만들어 가면 된다고 생각합니다.',
      date: '2026-08-28',
      sourceId: 'theminjoo-choi-dissent-deliberation',
      boundary: '최고위원회의 개인 발언입니다. 특정 이견의 사실관계·원인·해결, 당의 최종 방침 또는 당내 갈등 해소를 입증하는 자료로 표시하지 않습니다.',
    },
    {
      id: 'han-min-soo-unity-and-expansion',
      person: { id: 'han-min-soo', name: '한민수', office: '더불어민주당 최고위원', portrait: { url: 'https://theminjoo.kr/people/connect/people/1422/profile.jpg', sourceUrl: 'https://theminjoo.kr/main/sub/introduce/team.php?class=2', label: '더불어민주당 공개 프로필 사진' } },
      recordClass: '당 공식 회의 발언',
      issueLabel: '전당대회 이후 진영 단합·외연 확대 언급',
      status: '직접 확인',
      quote: '민주개혁 진영이 하나로 똘똘 뭉치는 것과 더불어민주당이 배출한 자랑스러운 네 분의 대통령 김대중 대통령님, 노무현 대통령님, 문재인 대통령님, 이재명 대통령님을 사랑하는 지지자들을 하나로 묶어내는 것입니다.',
      date: '2026-08-28',
      sourceId: 'theminjoo-han-unity-and-expansion',
      boundary: '최고위원회의 개인 발언입니다. 진영·지지자의 실제 결집, 외연 확대의 성과, 특정 세력과의 합당·연대 또는 당의 최종 방침을 입증하는 자료로 표시하지 않습니다.',
    },
    {
      id: 'seo-mi-hwa-policy-processing',
      person: { id: 'seo-mi-hwa', name: '서미화', office: '더불어민주당 최고위원', portrait: { url: 'https://theminjoo.kr/people/connect/people/13171917/profile.jpg', sourceUrl: 'https://theminjoo.kr/main/sub/introduce/team.php?class=2', label: '더불어민주당 공개 프로필 사진' } },
      recordClass: '당 공식 회의 발언',
      issueLabel: '정기국회 민생·주택 공급 현안 처리 계획',
      status: '직접 확인',
      quote: '오직 국민과 민생을 가장 중심에 두고 국민의 삶과 밀접한 부동산 공급 대책과 3대 메가프로젝트를 뒷받침할 수 있는 메가특구법 제정과 미래대응기금 설치를 비롯한 민생과 미래를 위한 현안들을 신속하게 민주당은 처리하겠습니다.',
      date: '2026-08-28',
      sourceId: 'theminjoo-seo-policy-processing',
      boundary: '최고위원회의 개인 발언입니다. 법안·기금·공급 대책의 최종 확정·국회 처리·정책 효과 또는 예산 집행 결과를 입증하는 자료로 표시하지 않습니다.',
    },
    {
      id: 'lee-seong-yoon-disaster-recovery-plan',
      person: { id: 'lee-seong-yoon', name: '이성윤', office: '더불어민주당 최고위원', portrait: { url: 'https://theminjoo.kr/people/connect/people/011301720/profile.jpg', sourceUrl: 'https://theminjoo.kr/main/sub/introduce/team.php?class=2', label: '더불어민주당 공개 프로필 사진' } },
      recordClass: '당 공식 회의 발언',
      issueLabel: '경북 산불·집중호우 피해 복구·예방 언급',
      status: '직접 확인',
      quote: '민주당은 신속한 피해 복구 지원과 사전 예방을 위해 최선의 노력을 다하겠습니다.',
      date: '2026-08-26',
      sourceId: 'theminjoo-lee-disaster-recovery',
      boundary: '최고위원회의 개인 발언입니다. 특정 지역의 피해 규모·복구 완료·지원 집행 또는 예방 정책의 효과를 입증하는 자료로 표시하지 않습니다.',
    },
    {
      id: 'park-sun-won-local-outreach',
      ...
      recordClass: '당 공식 회의 발언',
      issueLabel: '경북·안동 지역 유권자와의 소통·접근 언급',
      status: '직접 확인',
      quote: '그래서 저희가 더 노력하겠습니다. 더 가까이 다가오겠습니다.',
      date: '2026-08-26',
      sourceId: 'theminjoo-park-local-outreach',
      boundary: '최고위원회의 개인 발언입니다. 지역 유권자의 실제 지지 변화, 지역 사업 성과 또는 선거 결과를 입증하는 자료로 표시하지 않습니다.',
    },
    {
      id: 'han-byung-do-missing-person-law-discussion',
      person: { id: 'han-byung-do', name: '한병도', office: '더불어민주당 원내대표', portrait: { url: 'https://theminjoo.kr/people/connect/people/12006570/profile.png', sourceUrl: 'https://theminjoo.kr/main/sub/introduce/team.php?class=1', label: '더불어민주당 공개 프로필 사진' } },
      recordClass: '당 공식 회의 발언',
      issueLabel: '성인 실종 관련 입법 논의 계획',
      status: '직접 확인',
      quote: '이번 정기국회에서 관련 법안의 논의를 서두르겠습니다.',
      date: '2026-08-27',
    ...
    {
      id: 'han-byung-do-police-accountability',
      person: { id: 'han-byung-do', name: '한병도', office: '더불어민주당 원내대표', portrait: { url: 'https://theminjoo.kr/people/connect/people/12006570/profile.png', sourceUrl: 'https://theminjoo.kr/main/sub/introduce/team.php?class=1', label: '더불어민주당 공개 프로필 사진' } },
      recordClass: '당 공식 회의 발언',
      issueLabel: '경찰 수사 책임성·민주적 통제 언급',
      status: '직접 확인',
      quote: '경찰은 권한이 커진 만큼 수사 역량과 높은 책임성, 과정의 투명성과 민주적 통제도 한층 더 강화해야 합니다.',
      date: '2026-08-25',
      sourceId: 'theminjoo-han-police-accountability',
      boundary: '원내대책회의에서 한병도 원내대표가 한 경찰 제도 관련 발언입니다. 개별 사건의 사실관계·수사 결과, 제도 개정의 확정·시행 또는 신뢰 회복의 결과를 입증하는 자료로 표시하지 않습니다.',
    },
    {
    ...
    {
      id: 'kim-min-seok-kang-min-gu-dismissal-direction',
      person: { id: 'kim-min-seok', name: '김민석', office: '더불어민주당 당대표', portrait: { url: 'https://theminjoo.kr/people/connect/people/364/profile.jpg', sourceUrl: 'https://theminjoo.kr/main/sub/introduce/team.php?class=2', label: '더불어민주당 공개 프로필 사진' } },
      recordClass: '당 언론공지에 인용된 인사 조치',
      issueLabel: '윤리감찰단 부단장 즉시 해임 지시',
      status: '직접 확인',
      quote: '김민석 대표가 윤리감찰단 강민구 부단장의 즉시 해임을 지시했다',
      date: '2026-09-01',
      sourceId: 'chosunbiz-kim-kang-dismissal-direction',
      boundary: '더불어민주당 언론공지를 인용한 보도에서 확인되는 김민석 당대표의 인사 조치입니다. 이 기록은 해임 지시의 존재와 대상만 보여주며, 해임 사유, 텔레그램 메시지의 진위·의미, 당내 계파 관계, 감찰단 운영의 적법성 또는 조치의 정당성을 판단하지 않습니다.',
    },
    {
      id: 'noh-jong-myeon-gongchimo-explanation',
      person: { id: 'noh-jong-myeon', name: '노종면', office: '더불어민주당 국회의원', portrait: { url: 'https://www.assembly.go.kr/static/portal/img/openassm/new/4abfcdd3a1e84d28901c894e8c1189fe.jpg', sourceUrl: 'https://www.assembly.go.kr/members/22nd/NOHJONGMYUN', label: '대한민국국회 공개 프로필 사진' } },
      recordClass: '본인 SNS 해명',
      issueLabel: '공취모 관련 방송 발언의 맥락 설명',
      status: '직접 확인',
      quote: '저는 한번도 공취모 앞에 대통령이 있다고 인식해본 적이 없어요.',
      date: '2026-09-01',
  ...
  sources: [
    ...
    { id: 'theminjoo-choi-dissent-deliberation', title: '더불어민주당 공보국 — 제6차 최고위원회의 모두발언', url: 'https://www.theminjoo.kr/main/sub/news/view.php?sno=0&brd=230&post=1219869&search=', tier: '당 공식 회의 발언', date: '2026-08-28', caveat: '더불어민주당 공보국이 공개한 제6차 최고위원회의 최민희 발언입니다. 당내 이견을 토론·숙의로 다루겠다는 개인 발언의 범위이며, 특정 이견의 사실관계·해결 또는 최종 당 방침을 입증하지 않습니다.' },
    { id: 'theminjoo-han-unity-and-expansion', title: '더불어민주당 공보국 — 제6차 최고위원회의 모두발언', url: 'https://www.theminjoo.kr/main/sub/news/view.php?sno=0&brd=230&post=1219869&search=', tier: '당 공식 회의 발언', date: '2026-08-28', caveat: '더불어민주당 공보국이 공개한 제6차 최고위원회의 한민수 발언입니다. 진영 단합·외연 확대를 언급한 개인 발언의 범위이며, 실제 결집·합당·연대 성사 또는 최종 당 방침을 입증하지 않습니다.' },
    { id: 'theminjoo-seo-policy-processing', title: '더불어민주당 공보국 — 제6차 최고위원회의 모두발언', url: 'https://www.theminjoo.kr/main/sub/news/view.php?sno=0&brd=230&post=1219869&search=', tier: '당 공식 회의 발언', date: '2026-08-28', caveat: '더불어민주당 공보국이 공개한 제6차 최고위원회의 서미화 발언입니다. 정기국회 현안 처리 계획에 관한 개인 발언의 범위이며, 법안·기금·공급 대책의 최종 확정·처리 또는 정책 효과를 입증하지 않습니다.' },

...
export const convention = Object.freeze({
  ...
  sources: [
    ...
    { id: 'theminjoo-han-unity-and-expansion', title: '더불어민주당 공보국 — 제6차 최고위원회의 한민수 모두발언', url: 'https://www.theminjoo.kr/main/sub/news/view.php?sno=0&brd=230&post=1219869&search=', tier: '당 공식 회의 발언', date: '2026-08-28', caveat: '더불어민주당 공보국이 공개한 제6차 최고위원회의 한민수 발언입니다. 진영 단합·외연 확대를 언급한 개인 발언의 범위이며, 실제 결집·합당·연대 성사 또는 최종 당 방침을 입증하지 않습니다.' },
